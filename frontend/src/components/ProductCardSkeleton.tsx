export function ProductCardSkeleton() {
  return (
    <div className="animate-pulse rounded-2xl border border-accent/70 bg-background p-4 shadow-sm">
      ...
      <div className="mt-6 space-y-3 rounded-2xl border border-accent/70 bg-accent p-4">
