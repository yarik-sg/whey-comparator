    ...
    <section className="relative overflow-hidden py-24">
      ...
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-muted dark:text-muted/70">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 xl:grid-cols-6">
          {cards.map(({ id, label, description, icon, iconColor, query, count, animationDelay }) => (
            <motion.button
              ...
              className="text-left"
            >
              <Card className="group relative h-full overflow-hidden border-white/20 bg-white/75 p-6 text-left shadow-glass transition hover:-translate-y-1 hover:border-primary/30 hover:shadow-fitidion dark:border-white/10 dark:bg-slate-900/60">
                ...
                <div className="relative flex items-start justify-between">
                  <span
                    className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-white/15 text-2xl text-primary backdrop-blur ${iconColor}`}
                    aria-hidden
                  >
                    {icon}
                  </span>
                ...
                <p className="relative mt-3 text-sm leading-relaxed text-muted dark:text-muted/70">{description}</p>
